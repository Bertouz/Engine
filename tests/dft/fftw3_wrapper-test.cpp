            ...
            WHEN("calling fft1d(dft::policy::fftw, signal.begin(), signal.end(), spectrum.begin())")
            {
                ...
                THEN("The periodogram is correctly allocated")
                {
                    ...
                    std::vector<double> ref_spectrum_real{
                        1.7071067812,  1.7322337742,  1.8140021164,  1.9774196978,  2.2975759404,  3.0872975643,
                        9.5809808711,  -0.8365844907, 0.9764081408,  1.8763094389,  2.9659772208,  5.1942055518,
                        15.881218621,  -15.881218621, -5.1942055518, -2.9659772208, -1.8763094389, -0.9764081408,
                        0.8365844907,  -9.5809808711, -3.0872975643, -2.2975759404, -1.9774196978, -1.8140021164,
                        -1.7322337742, -1.7071067812};

                    std::vector<double> ref_spectrum_imag{0.0,           -0.0914985754,
