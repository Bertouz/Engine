            ...
            WHEN("calling spp::periodogram(signal.begin(), signal.end(), periodogram.begin())")
            {
                ...
                THEN("The periodogram is correctly allocated")
                {
                    std::vector<double> ref_periodogram{
                        0.0354399344, 0.0365927092, 0.0405069557, 0.049102699, 0.0691117078, 0.1379116003, 1.839030475, 0.1113244813, 0.0355048641, 0.0550657242,
                        0.1153842119, 0.3348894392, 3.0733326452, 3.0733326452, 0.3348894392, 0.1153842119, 0.0550657242, 0.0355048641, 0.1113244813, 1.839030475,
                        0.1379116003, 0.0691117078, 0.049102699, 0.0405069557, 0.0365927092, 0.0354399344
                    };
